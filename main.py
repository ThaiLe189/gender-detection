...
audio_paths = ["/home/torusadmin/Desktop/Torus/gender-detection/audio.wav"] # Must be a list with absolute paths of the audios that will be used in inference
...
preds = get_gender(model_name_or_path, audio_paths, label2id, id2label, "cpu")
print(preds)
